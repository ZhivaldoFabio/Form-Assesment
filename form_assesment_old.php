            ...
            <div id="content1">
                ...
                <div class="option">
                    <div class="select-box">
                        <select name="gender" id="jenis_kelamin">
                ...
                <input type="text" name="pob" placeholder="Masukkan Tempat Lahir" class="input-text">
                <!-- <br>
                <br> -->
                <input type="text" name="dob" placeholder="Masukkan Tanggal Lahir" class="input-text">
                <br>
                <br>
                <!-- ==================================================================================================== -->
